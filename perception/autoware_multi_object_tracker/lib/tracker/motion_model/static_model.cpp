  ...
  geometry_msgs::msg::Twist & twist, std::array<double, 36> & twist_cov) const
{
  ...
  constexpr double vv_cov = 0.1 * 0.1;  // TODO(yukkysaito) Currently tentative
  // rotate covariance matrix
  twist_cov[XYZRPY_COV_IDX::X_X] = vv_cov;
  twist_cov[XYZRPY_COV_IDX::X_Y] = vv_cov;
  twist_cov[XYZRPY_COV_IDX::Y_X] = vv_cov;
  twist_cov[XYZRPY_COV_IDX::Y_Y] = vv_cov;
  twist_cov[XYZRPY_COV_IDX::Z_Z] = vv_cov;
  twist_cov[XYZRPY_COV_IDX::ROLL_ROLL] = vv_cov;
  twist_cov[XYZRPY_COV_IDX::PITCH_PITCH] = vv_cov;
  twist_cov[XYZRPY_COV_IDX::YAW_YAW] = vv_cov;
