...
PathGenerator::PathGenerator(
  const double sampling_time_interval, const double min_crosswalk_user_velocity, autoware::universe_utils::TimeKeeper & time_keeper)
: sampling_time_interval_(sampling_time_interval),
  min_crosswalk_user_velocity_(min_crosswalk_user_velocity),
  time_keeper_(time_keeper)
{
  is_time_keeper_set_ = true;
}
...
{
  if (is_time_keeper_set_) autoware::universe_utils::ScopedTimeTrack st(__func__, time_keeper_);
