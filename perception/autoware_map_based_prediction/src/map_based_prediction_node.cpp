  ...
  const lanelet::Id & signal_id)
{
  ...
  std::vector<double> MapBasedPredictionNode::calcTrajectoryCurvatureFrom3Points(
  ...
  TrajectoryPoints MapBasedPredictionNode::toTrajectoryPoints(const PredictedPath & path, const double velocity)
  {
    autoware::universe_utils::ScopedTimeTrack st(__func__, time_keeper_);
  ...
  bool MapBasedPredictionNode::isLateralAccelerationConstraintSatisfied(
